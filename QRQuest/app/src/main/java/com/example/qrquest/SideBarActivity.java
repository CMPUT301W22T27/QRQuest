...
import com.example.qrquest.databinding.ActivitySideBarBinding;
...
public class SideBarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_home, R.id.nav_profile, R.id.nav_scoreboard,R.id.nav_search, R.id.nav_logout, R.id.nav_viewQR)
