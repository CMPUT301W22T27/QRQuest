...
public class ReLogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TestButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(ReLogin.this, SideBarActivity.class);
        ...
        createAccountButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ReLogin.this, CreateAccount.class);
                startActivity(intent);
            }
        });
        logInButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Scanner scanner = new Scanner(view, ReLogin.this);
                scanner.startScan();
            }
        });
    }
    ...
    protected void onActivityResult ( int requestCode, int resultCode, @Nullable Intent data){
        ...
        if (intentResult.getContents() != null) {
            AlertDialog.Builder builder = new AlertDialog.Builder(ReLogin.this);
            ...
            collectionReference.document(qrCode.getHash()).get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                ...
                public void onComplete(@NonNull Task<DocumentSnapshot> taskout) {
                    if (taskout.getResult().exists()) {
                        Intent intent = new Intent(ReLogin.this, MainScreen.class);
