...
public class CreateAccount extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        usernameEditText = findViewById(R.id.editTextTextUserName); // these need to be changed
        ...
        confirmButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final String userDisplay = emailEditText.getText().toString();
...
//                mDatabase = FirebaseDatabase.getInstance().getReference();
                // mDatabase.child("Users").child(email).get().addOnCompleteListener(new OnCompleteListener<DataSnapshot>() {
                    ...
                    //           });
                final CollectionReference collectionReference = db.collection("Users");
                collectionReference.document(userDisplay).get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                    @Override
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if (task.getResult().exists()) {
                            ...
                            data.put("Username", newUser.getUserID());
                            collectionReference.document(userDisplay).set(data);
                            Intent intent = new Intent(CreateAccount.this, MainScreen.class);
                            intent.putExtra("USER_ID_CreateAccount",userID);
                            intent.putExtra("USER_DISPLAY_CreateAccount",userDisplay);
